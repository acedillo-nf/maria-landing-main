...
export function VortexSection() {
  return (
      <div className=" mx-auto h-[60rem] overflow-hidden flex items-center content-center pt-64 ">
          <Vortex
              backgroundColor="black"
              className="w-full h-full inset-0 "
          />
          <div className=" absolute flex items-center justify-center w-full h-full px-16">
